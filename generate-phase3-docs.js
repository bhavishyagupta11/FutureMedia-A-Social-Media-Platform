...
const phase3Docs = {
  ...
  "intelligence/INTELLIGENCE_ARCHITECTURE.md": "# Intelligence Architecture\n\nThe SocialLoop Intelligence Platform (SLIP) uses an independent Python/FastAPI microservice separate from the Node.js business logic.",
